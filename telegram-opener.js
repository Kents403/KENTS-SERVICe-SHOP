...
class TelegramOpener {
    ...
    openTelegram(message, phone = '') {
        // Telegram URL ni tayyorlash
        let telegramUrl = `https://t.me/kentservice_support`;
        ...
        // Qurilma bo'yicha optimallashtirilgan ochish
        switch(device) {
            case 'ios':
    ...
    openIOS(url, message) {
        ...
        // 1. Avval ogohlantirish
        this.showIOSModal(url, message);
        
        // 2. Background da ochish urinishi
        setTimeout(() => {
    ...
    openDesktop(url) {
        ...
        // Desktop uchun yangi tab
        window.open(url, '_blank', 'noopener,noreferrer,width=800,height=600');
        return true;
    }
    
    // ===== UNIVERSAL (Hamma uchun) =====
    openUniversal(url, message) {
        console.log('Universal method');
        
        // 3 xil usul bilan urinish
        try {
            // Usul 1: Yangi tab
        ...
        modal.innerHTML = `
            ...
            ">
                ...
                <p style="color: #666; margin-bottom: 25px; line-height: 1.5;">
                    Quyidagi tugmani bosing yoki Telegram ilovasida <strong>@kentservice_support</strong> ga o'tib, xabarni yuboring.
                </p>
